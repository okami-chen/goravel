...
require (
	...
	github.com/wangluozhe/requests v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/charmbracelet/huh/spinner v0.0.0-20240614151011-d7db0175f0c1 // indirect
...
replace github.com/wangluozhe/requests => ./src/requests
